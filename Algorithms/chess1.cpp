...
bool chk(int (&arr)[8][8]){
		for(int i=0; i<8; i++){
			for(int j=0; j<8; j++){
			//	cout<<"The position is : "<<i<<"and : "<<j<<"with val : "<<arr[i][j]<<"   ";
